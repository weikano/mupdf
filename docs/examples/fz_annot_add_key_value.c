/**
 * 
    gcc -I/usr/local/include -o fz_annot_add_key_value \
	/home/weikan/git/mupdf-android-fitz/libmupdf/docs/examples/fz_annot_add_key_value.c \
	/usr/local/lib/libmupdf.a \
	/usr/local/lib/libmupdf-third.a \
	-lm
./fz_annot_add_key_value document.pdf
*/
